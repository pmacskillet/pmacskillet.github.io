...
<div class="row">
    ...
    <div class="col-md-6">
        <img src="/images/Slaughterhouse-beach.jpg" class="img-fluid" alt="Slaughterhouse Beach">
    </div>
</div>
   
<div class="row">
    <div class="col-md-6">
        <img src="/images/west-point-maui.jpg" class="img-fluid" alt="Sunset Point">
        <img src="/images/Sunet-cruise.jpg" class="img-fluid" alt="Sunset Point">
    </div>
    <div class="col-md-6">
      <p>
