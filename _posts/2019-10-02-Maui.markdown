...
<div>
  <img src="/images/west-point-maui.jpg" alt="Sunset Point" class="pull-right ml-2" max-width="70%">
  <img src="/images/Sunet-cruise.jpg" alt="Sunset Cruise" class="pull-right ml-2" max-width="70%">
  <p>
